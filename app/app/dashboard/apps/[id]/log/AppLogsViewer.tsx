    ...
    <div>
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          onClick={() => fetchLogs()}
          disabled={loading}
          className="rounded-native-sm border border-gl-edge bg-gl-input-bg px-3 py-1.5 text-xs font-medium text-gl-text-muted transition hover:bg-gl-hover disabled:opacity-50"
        >
