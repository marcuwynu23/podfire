  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-white/[0.06] bg-gl-sidebar/95 shadow-sm backdrop-blur-md">
      <div className="flex h-11 w-full items-center justify-between gap-3 px-3 sm:px-4 lg:px-6">
        <Link
          href="/dashboard"
          className="shrink-0 text-base font-semibold text-white transition hover:text-primary"
        >
          Dockly
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={ref}>
            ...
            >
              ...
              <svg className={`h-3.5 w-3.5 text-zinc-400 transition ${profileOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {profileOpen && (
              <div className="absolute right-0 top-full z-50 mt-1.5 w-52 rounded-lg border border-white/[0.08] bg-gl-card py-2 shadow-sm">
                <div className="border-b border-white/[0.06] px-3 py-2">
                  <p className="truncate text-sm font-medium text-white">{accountLabel ?? "Account"}</p>
